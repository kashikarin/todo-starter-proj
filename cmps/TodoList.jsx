...
export function TodoList({ todos, onRemoveTodo, onToggleTodo }) {
    ...
    return (
        <ul className="todo-list">
            {todos.map(todo => (<li key={todo._id} style={{backgroundColor: todoColors[todo._id]? todoColors[todo._id].color : 'transparent', backgroundImage: todoColors[todo._id] ? 'none' : undefined}}>
